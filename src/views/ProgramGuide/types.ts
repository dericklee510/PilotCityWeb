...
export class RouteList {
    ...
    public get studentSequenceRouteHash():Record<string,Boolean | firebase.firestore.Timestamp | firebase.firestore.FieldValue | Date | undefined>{
        return {
            ...
            'stud-project-casestudy':isBoth(FbStore.currentTeacherProgramData?.programSequence?.caseStudies , FbStore.currentProject?.programSequence?.train),
            'stud-project-practicelog':isBoth( FbStore.currentTeacherProgramData?.programSequence?.practice , FbStore.currentProject?.programSequence?.caseStudies),
