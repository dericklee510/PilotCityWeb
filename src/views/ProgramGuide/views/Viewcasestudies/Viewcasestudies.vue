<template>
  <v-container>
    <v-row justify="center">
      ...
      <v-col id="viewcasestudies__contain" cols="8">
        <v-row justify="center" class="viewcasestudies__title">
          <v-col class="text-center" cols="9">REVIEW CASE STUDIES & USE CASES</v-col>
        </v-row>

        <v-col cols="12" class="viewcasestudies__borderline" />

        <v-row justify="center" class="viewcasestudies__description">
          <v-col
            cols="9"
            class="text-center"
          >It is important to create unique and innovative solutions. Review what’s been done before so you don’t reinvent the wheel.</v-col>
        </v-row>
        <v-row class="viewcasestudies__reviewtitle" no-gutters justify="end">
          <v-col class="text-start" cols="10">Reviewed</v-col>
        </v-row>
        ...
        <v-row
          ...
          no-gutters
        >
          <v-col cols="10" class="text-start viewcasestudies__wholeline">
            <input
            ...
            />
            {{ namedLink.linkName }}
            <a :href="namedLink.link" target="_blank">
