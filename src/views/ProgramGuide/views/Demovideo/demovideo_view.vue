<template>
  <v-container>
    <v-row justify="center" no-gutters>
      <img id="demovideo_view__icon" src="@/assets/demovideo_view.png" />

      <v-col id="demovideo_view__contain" cols="8" class="pb-9">
        <v-row
          justify="center"
          class="mr-auto ml-auto demovideo_view__title"
        >VIEW 1-MINUTE PROTOTYPE DEMONSTRATION VIDEOS</v-row>

        <v-col id="demovideo_view__borderline" cols="12" />
