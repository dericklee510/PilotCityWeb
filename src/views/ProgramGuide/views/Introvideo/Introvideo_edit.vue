<template>
  <v-container>
    <v-row justify="center" no-gutters>
      <img id="introvideo_edit__icon" src="@/assets/watchintrovideo_edit.png" />

      <v-col id="introvideo_edit__contain" cols="8">
        <v-row justify="center" no-gutters style="border-bottom: solid 0.75px #404142;">
          <v-col
            cols="9"
        ...
        <v-row justify="center" no-gutters>
          ...
          >Record, upload and enter link for an introduction video to your project challenge for students to view.</v-col>
        </v-row>

        <ValidationObserver v-slot="{invalid}">
          <v-row justify="center" class="mr-auto ml-auto mt-12 mb-12" no-gutters>
            <v-col cols="9" md="7">
              <LinkChecker
                v-model="url"
                :success="success"
          ...
          <v-row no-gutters justify="center" align="center">
            <v-col cols="9" class="introvideo_edit__check">
