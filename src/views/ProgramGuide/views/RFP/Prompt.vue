  ...
  <v-container>
    <v-row no-gutters justify="center">
      ...
      <v-col id="prompt__contain" cols="8">
        ...
        <v-row justify="center" no-gutters class="prompt__description mb-10">
          <v-col
            class="text-center"
            cols="9"
          >Generate project prompts that best represent employer requirements and your course curriculum by tweaking key information in the mission.</v-col>
        </v-row>

        <v-row justify="center" class="prompt__header">Step 1</v-row>

        <v-row justify="center" class="prompt__divider ml-auto mr-auto mt-5 mb-5" />

        <v-row justify="center" no-gutters class="prompt__headerdescription mb-12">
          <v-col class="text-center" cols="9">Enter the parameters of the employer's project</v-col>
        </v-row>
        ...
        <v-row justify="center" class="prompt__header mt-12">Step 2</v-row>
        <v-row justify="center" class="prompt__divider ml-auto mr-auto mt-5 mb-5" />

        <v-row justify="center" no-gutters class="prompt__headerdescription mb-12">
          <v-col class="text-center" cols="9">Choose an option you'd like to edit and finalize</v-col>
        </v-row>

        <v-col>
          <v-row class="mt-5 mb-5" justify="center">
            <span class="prompt__generatedtitle--color1">TECH-DRIVEN</span>
            <span class="ml-3 prompt__choosebutton" @click="changeTemplate('tech')">Choose</span>
          </v-row>
          <v-row class="prompt__generated mt-5 mb-12" justify="center">{{ promptTech }}</v-row>

          <v-row class="mt-5 mb-5" justify="center">
            <span class="prompt__generatedtitle--color2">SOLUTION-DRIVEN</span>
            <span class="ml-3 prompt__choosebutton" @click="changeTemplate('solution')">Choose</span>
          </v-row>
          <v-row class="prompt__generated mt-5 mb-12" justify="center">{{ promptSolution }}</v-row>

          <v-row class="mt-5 mb-5" justify="center">
            <span class="prompt__generatedtitle--color3">PROBLEM-DRIVEN</span>
            <span class="ml-3 prompt__choosebutton" @click="changeTemplate('problem')">Choose</span>
          </v-row>
          <v-row class="prompt__generated mt-5 mb-12" justify="center">{{ promptProblem }}</v-row>

          <v-row class="mt-5 mb-5" justify="center">
            <span class="prompt__generatedtitle--color4">METRIC-DRIVEN</span>
            <span class="ml-3 prompt__choosebutton" @click="changeTemplate('metric')">Choose</span>
          </v-row>
          <v-row class="prompt__generated mt-5 mb-12" justify="center">{{ promptMetric }}</v-row>
        </v-col>

        <v-row justify="center" class="prompt__header mt-8">Step 3</v-row>
        <v-row justify="center" class="prompt__divider ml-auto mr-auto mt-5 mb-5" />
        ...
        <v-row justify="center" no-gutters class="prompt__headerdescription mb-12">
          <v-col
            class="text-center"
            cols="9"
          >Fine-tune and finalize your project prompt with employer</v-col>
        </v-row>

        <v-row justify="center" no-gutters>
          <v-col cols="9">
            <textarea v-model="finalPrompt" class="prompt__finalize" />
          </v-col>
        </v-row>
