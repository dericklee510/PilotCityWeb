<template>
  <v-container>
    <v-row justify="center">
      <img id="editcasestudies__icon" class="editcasestudies__image" src="@/assets/Reviewcase.png" />

      <v-col id="editcasestudies__contain" cols="8">
        <v-row justify="center" no-gutters class="editcasestudies__title">
          <v-col class="text-center" cols="9">ENTER CASE STUDIES & USE CASES</v-col>
        </v-row>

        <v-col cols="12" class="editcasestudies__borderline" />

        <v-row justify="center" no-gutters class="editcasestudies__description">
          <v-col
            class="text-center"
            cols="9"
          >Share key articles, publications and links that support the student’s understanding of the technology, product or service.</v-col>
        </v-row>
        ...
        <multi-input v-model="links" v-slot="{entries,newEntry,deleteEntry}">
          <v-row
