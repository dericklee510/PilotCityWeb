  ...
  <v-row justify="center">
    ...
    >
      ...
      <v-row id="posthack__check1">
        <span class="posthack__wholeline"><input
                                            class="posthack__check"
                                            type="checkbox"
                                          >Update Business Model Canvas 

          <span class="posthack__error">*</span>
          <span><button class="posthack__exporticon"><img src="@/assets/greenexport.png"></button></span>

        </span>
      </v-row>

      <v-row>
        <span class="posthack__descriptionline">
      ...
      <v-row>
        <button class="posthack__acknowledgebutton">
          ACKNOWLEDGE
        </button>
      </v-row>
    </v-col>
