<template>
  <v-row class="mt-12" justify="center">
    <v-col cols="8">
      ...
      <v-row class="myprograms__categorytitle mt-12 mb-6">Active</v-row>
      ...
      <v-row class="myprograms__card">
          ...
          <v-col cols="9">
              ...
              <v-row class="myprograms__progresspercentage">90%</v-row>
              <v-row>
                  <v-col cols="9">
                  ...
                  <v-col cols="3"><button class="myprograms__cardbutton">Open</button></v-col>
              </v-row>
          </v-col>
      </v-row>
 ...
 <!-- ADD CARD -->
      ...
      <v-row justify="center" class="myprograms__addcard mt-9">+</v-row>


      <!-- COMPLETED -->

      <v-row class="myprograms__categorytitle mt-12 mb-6">Completed</v-row>

      <v-row justify="center" class="myprograms__cardcompletednonev2 mb-12">No completed programs yet<i class="ml-3 mt-1 far fa-grin-beam-sweat"></i></v-row>
