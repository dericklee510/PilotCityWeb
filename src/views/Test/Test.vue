<template>
  <v-container fluid class="pc-profile-page">
    <v-row justify="end">
      <!-- <div > -->
      <v-col xl="2" lg="3" md="4" sm="5" cols="8" style="padding: 0;" align-self="center">
        <div id="profileSwitch" style="display: flex">
          <!-- gotta make this switch work -->
          <v-switch text readonly>
    ...
    <v-container fluid>
      <v-card class="pc-container pc-profile-page--dark">
        ...
        <img id="profileBanner" src="@/assets/banner-1018818_960_720.jpg" alt="">
        <v-container>
          ...
          <v-row>
            ...
            <v-col cols="12" md="7" class="pl-6" style="padding-bottom: 0">
              <v-row justify="start">
                <v-col cols="12">
                  <h1>{{ Name }}</h1>
                </v-col>
                <v-col cols="12" md="4">
                  <v-menu max-width="300px" content-class="pc-v-center" :offset-y="true">
                    <template v-slot:activator="{ on, attrs }">
                      <v-row justify="center">
                        <v-col>
                          <v-btn :id="CITIZENSTYLES[citizenType]" v-bind="attrs" rounded v-on="on">
                    ...
                    <v-list style="padding: 0">
                      <v-list-item v-for="(type, index) in AVAILABLETYPES" :key="type + index" style="padding: 0;" @click="changeCitizenType(type)">
                ...
                <v-col v-if="ispublic" cols="12" md="4" align-self="center">
                  <h3>Fremont, CA</h3>
                </v-col>
              </v-row>
            </v-col>
          ...
          <v-container>
            <v-list id="profileFields" class="pc-profile-page--dark" text>
              <v-list-item-title style="max-width: fit-content" v-text="'Citizen'" />
              <v-list-item>
                <v-list-item-content>
                  <v-col cols="12" class="pt-0">
                    <v-row id="citizen-id__base-questions" justify="start">
                      <v-col cols="12">
                        <v-col cols="12" md="8" lg="6" xl="5">
                          <ValidationProvider v-slot="{errors}" rules="required">
                            <pcTextfield v-model="citizen.first_name" :dark-mode="true" title="FIRST NAME" placeholder="First Name" :error-messages="errors" />
                          </ValidationProvider>
                          <ValidationProvider v-slot="{errors}" rules="required">
                            <pcTextfield v-model="citizen.last_name" :error-messages="errors" :dark-mode="true" title="LAST NAME" placeholder="Last Name" />
                          </ValidationProvider>
                          <ValidationProvider v-slot="{errors}" rules="required">
                            <pcTextfield v-model="citizen.position" :error-messages="errors" :dark-mode="true" title="POSITION" placeholder="Role" />
                          </ValidationProvider>
                          <ValidationProvider v-slot="{errors}" rules="required">
                            <pcTextfield v-model="citizen.organization" :error-messages="errors" :dark-mode="true" title="ORGANIZATION" placeholder="Company Name" />
                          </ValidationProvider>
                        </v-col>
                      </v-col>
                    </v-row>
              ...
              <v-list-item-title style="max-width: fit-content" v-text="'Organization'" />
              <v-list-item>
                <v-list-item-content>
                  <v-col cols="12">
                    <v-row justify="start">
                      <v-col cols="12">
                        <v-col cols="12" md="8" lg="6" xl="5">
                          <ValidationProvider v-slot="{errors}" rules="required">
                            <pcTextfield v-model="organization.department" :error-messages="errors" :dark-mode="true" title="Your Department" placeholder="Enter Department Name" />
                          </ValidationProvider>
                        </v-col>
                        <v-col cols="12" md="8" lg="6" xl="5">
                          <ValidationProvider v-slot="{errors}" rules="required">
                            <autoComplete v-model="organization.location" :error-messages="{errors}" />
                          </ValidationProvider>
                        </v-col>
                        <ValidationProvider v-slot="{errors}" rules="required">
                          <v-col cols="12">
                            <v-col cols="12">
                              <v-row>
                                <h4 style="color:#C7C8CA" class="text-uppercase">
                                  Industry
                                </h4>
                            ...
                            <v-col cols="12" md="8" lg="6" xl="5">
                              <pcCheckbox v-model="organization.industry" :options="ORGANIZATION_INDUSTRY_OPTIONS" :other="false" />
                            </v-col>
                          </v-col>
                        </ValidationProvider>
                        <ValidationProvider v-slot="{errors}" rules="required">
                        ...
                        <v-col cols="12" md="8" lg="6" xl="5">
                          <ValidationProvider v-slot="{errors}" rules="required">
                            <pcSelect v-model="organization.employee_count" :items="WORKFORCE_COUNT" :dark-mode="true" title="EMPLOYEE COUNT" placeholder="Select Number of Employees" />
                          </ValidationProvider>
                        </v-col>
                      </v-col>
                    </v-row>
              ...
              <v-list-item-title style="max-width: fit-content" v-text="'Program Details'" />
              <v-list-item>
                  ...
                  <v-list-item-content>
                    <v-col cols="12">
                      <v-row justify="start">
                        ...
                        <v-col cols="12" style="color:#C7C8CA">
                          <v-col cols="12">
                            <h4 style="color:#C7C8CA" class="text-uppercase">
                          ...
                          <v-col cols="12" md="8" lg="6" xl="5">
                            <ValidationProvider v-slot="{errors, failedRules}" :rules="{ required:true,regex: /^\d{4}\-(0[1-9]|1[012])\-(0[1-9]|[12][0-9]|3[01])$/ }">
                              <pcTextfield v-model="programdetails.externship.prefered_date.primary" :error-messages="failedRules.regex?'Not a valid date':errors" :dark-mode="true" placeholder="YYYY-MM-DD" title="First Choice" type="tel" v-mask="'2020-##-##'" />

                            </ValidationProvider>
                          </v-col>
                          <v-col cols="12" md="8" lg="6" xl="5">
                            <ValidationProvider v-slot="{errors, failedRules}" :rules="{ required:true,regex: /^\d{4}\-(0[1-9]|1[012])\-(0[1-9]|[12][0-9]|3[01])$/ }">
                              <pcTextfield v-model="programdetails.externship.prefered_date.secondary" :error-messages="failedRules.regex?'Not a valid date':errors" :dark-mode="true" placeholder="YYYY-MM-DD" type="tel" v-mask="'2020-##-##'" title="Second Choice" />
                            </ValidationProvider>
                          </v-col>
                          <v-col cols="12" md="8" lg="6" xl="5">
                            <ValidationProvider v-slot="{errors, failedRules}" :rules="{ required:true,regex: /^\d{4}\-(0[1-9]|1[012])\-(0[1-9]|[12][0-9]|3[01])$/ }">
                              <pcTextfield v-model="programdetails.externship.prefered_date.final" :error-messages="failedRules.regex?'Not a valid date':errors" :dark-mode="true" placeholder="YYYY-MM-DD" type="tel" v-mask="'2020-##-##'" title="Third Choice" />
                            </ValidationProvider>
                          </v-col>
                        </v-col>
                        <v-col cols="12">
                          <ValidationProvider v-slot="{errors}" rules="required">
                            <v-col cols="12">
                              ...
                              <v-col cols="12">
                                <pcCheckbox v-model="programdetails.externship.contribution" :options="PROGRAMDETAILS_EXTERNSHIP_CONTRIBUTION_OPTIONS" :other="true" />
                              </v-col>
                            </v-col>
                          </ValidationProvider>
                        </v-col>
                      ...
                      <v-row>
                        ...
                        <v-col cols="12">
                          <v-col cols="12">
                            <h4 id="text-uppercase" style="color:#c7c8ca">
                          ...
                          <v-col cols="12">
                            <v-row>
                              <v-col cols="12" md="4">
                                <ValidationProvider v-slot="{errors}" rules="required">
                                  <pcSelect v-model="programdetails.project.capacity.minimum" :dark-mode="true" :items="CLASSROOM_COUNT" title="" placeholder="Select Minimum" />
                                </ValidationProvider>
                              </v-col>
                              <v-col cols="4">
                                <ValidationProvider v-slot="{errors}" rules="required">
                                  <pcSelect v-model="programdetails.project.capacity.maximum" :dark-mode="true" :items="CLASSROOM_COUNT" title="" placeholder="Select Maximum" />
                                </ValidationProvider>
                              </v-col>
                            </v-row>
                          </v-col>
                            ...
                            <v-col cols="12">
                              <v-col cols="12" md="6">
                                <v-radio-group v-model="programdetails.project.engagement.type">
                                  <v-radio v-for="(eng, index) in PROGRAMDETAILS_PROJECT_ENGAGEMENT_TYPE_OPTIONS " :key="eng+index" :label="eng" :value="eng" />
                                </v-radio-group>
                              </v-col>
                            </v-col>
                          </ValidationProvider>
                            ...
                            <v-col>
                              <v-col cols="12" md="6">
                                <v-radio-group v-model="programdetails.project.engagement.radius">
                                  <v-radio v-for="(rad, index) in PROGRAMDETAILS_PROJECT_ENGAGEMENT_RADIUS_OPTIONS " :key="rad+index" :value="rad" :label="rad" />
                                </v-radio-group>
                              </v-col>
                            </v-col>
                          </ValidationProvider>
                      ...
                      <v-row>
                        ...
                        <v-col cols="12">
                          <ValidationProvider v-slot="{errors}" rules="required">
                            <v-col>
                              ...
                              <v-col cols="12">
                                <pcCheckbox v-model="internship.project" :options="INTERNSHIP_PROJECT_TYPE" :other="true" />
                              </v-col>
                            </v-col>
                          </ValidationProvider>
                            ...
                            <v-col cols="12">
                              <v-col cols="12" md="6">
                                <v-radio-group v-model="internship.travel">
                                  <v-radio v-for="option in ΙΝΤΕRN_TRAVEL_OPTIONS" :key="option" :label="option" :value="option" />
                                </v-radio-group>
                              </v-col>
                            </v-col>
                          </ValidationProvider>
                        ...
                        <ValidationProvider v-slot="{errors}" rules="required">
                          ...
                          <v-col cols="12">
                            <v-col cols="12" md="6">
                              <v-checkbox v-model="internship.education_level" label="Highschool" value="High school" hide-details />
                              <v-checkbox v-model="internship.education_level" label="Specialty Training" value="Specialty Training" hide-details />
                              <v-checkbox v-model="internship.education_level" label="Community College" value="Community College" hide-details />
                              <v-checkbox v-model="internship.education_level" label="Bachelors" value="Bachelors" hide-details />
                              <v-checkbox v-model="internship.education_level" label="Doctorate" value="Doctorate" hide-details />
                            </v-col>
                          </v-col>
                        </ValidationProvider>
                      </v-row>
                    ...
                    <ValidationProvider v-slot="{errors}" rules="required">
                      ...
                      <v-col cols="12">
                        <v-col cols="12" md="4">
                          <pcCheckbox v-model="internship.talent" :options="INTERNSHIP_TALENT_OPTIONS" :other="false" />
                        </v-col>
                      </v-col>
                    </ValidationProvider>
                    <ValidationProvider v-slot="{errors}" rules="required">
                      <v-col cols="12">
                        <v-row>
                          <h4 class="text-uppercase" style="color:#C7C8CA">
                      ...
                      <v-col cols="12">
                        <v-col cols="12" md="4">
                          <v-radio-group v-model="internship.days_week">
                            <v-radio v-for="(sched, index) in HOST_SCHED" :key="sched+index" :label="sched" :value="sched" />
                          </v-radio-group>
                        </v-col>
                      </v-col>
                    </ValidationProvider>
                      ...
                      <v-col cols="12">
                        <v-col cols="12" md="4">
                          <v-radio-group v-model="internship.hours_day">
                            <v-radio v-for="(freq, index) in HOST_FREQ" :key="freq+index" :label="freq" :value="freq" />
                          </v-radio-group>
                        </v-col>
                      </v-col>
                    </ValidationProvider>
                      ...
                      <v-col cols="12">
                        <v-col cols="12" md="4">
                          <v-radio-group v-model="internship.employer_of_record">
                            <v-radio v-for="(option, index) in EOR" :key="option+index" :label="option" :value="option" />
                          </v-radio-group>
                        </v-col>
                      </v-col>
                    </ValidationProvider>
                    <ValidationProvider v-slot="{errors}" rules="required">
                      ...
                      <v-col cols="12">
                        <v-col cols="12" md="4">
                          <pcCheckbox v-model="internship.compensation" :options="INTERN_COMP" :other="false" />
                        </v-col>
                      </v-col>
                    </ValidationProvider>
                    <v-col cols="12">
                        ...
                        <v-row>
                          <v-col cols="12" md="4">
                            <ValidationProvider v-slot="{errors}" rules="required|min_value:0">
                              <pcTextfield v-model="internship.budget_min" :error-messages="errors" :dark-mode="true" placeholder="Minimum" title="" />
                            </ValidationProvider>
                          </v-col>
                          <v-col cols="12" md="4">
                            <ValidationProvider v-slot="{errors}" rules="required|min_value:0">
                              <pcTextfield v-model="internship.budget_max" :error-messages="errors" :dark-mode="true" placeholder="Maximum" title="" />
                            </ValidationProvider>
                          </v-col>
                        </v-row>
                      </v-col>
                    ...
                    <v-col cols="12">
                      <v-col cols="12" md="8" lg="6" xl="5">
                        <ValidationProvider v-slot="{errors}" rules="required">
                          <pcTextfield v-model="internship.interview_1" :error-messages="errors" :dark-mode="true" placeholder="Primary option" title="First Choice" />
                        </ValidationProvider>
                      </v-col>
                      <v-col cols="12" md="8" lg="6" xl="5">
                        <ValidationProvider v-slot="{errors}" rules="required">
                          <pcTextfield v-model="internship.interview_2" :error-messages="errors" :dark-mode="true" placeholder="Secondary option" title="Second Choice" />
                        </ValidationProvider>
                      </v-col>
                      <v-col cols="12" md="8" lg="6" xl="5">
                        <ValidationProvider v-slot="{errors}" rules="required">
                          <pcTextfield v-model="internship.interview_3" :error-messages="errors" :dark-mode="true" placeholder="Final option" title="Third Choice" />
                        </ValidationProvider>
                      </v-col>
                    </v-col>
                    <ValidationProvider v-slot="{errors}" rules="required">
                    ...
                    <ValidationProvider v-slot="{errors}" rules="required">
                      ...
                      <v-col cols="12">
                        <v-col cols="12" md="4">
                          <pcCheckbox v-model="internship.position_type" :options="INTERNSHIP_POSITION_TYPE_OPTIONS" :other="false" />
                        </v-col>
                      </v-col>
                    </ValidationProvider>
                    <v-btn id="signup-button" block :loading="loading" :disabled="loading" class="mb-6" @click="syncStorage">
...
export default class Test extends CONST {
  ...
  syncStorageInternship() {
    if (this.internship) {
      ...
      localStorage.internships_travel = tableToDecimal(this.ΙΝΤΕRN_TRAVEL_OPTIONS, [this.internship.travel])
  ...
  testData() {
    ...
    this.organization = {
      location: { "street_number": "101", "route": "Estudillo Avenue", "locality": "San Leandro", "administrative_area_level_1": "CA", "country": "United States", "postal_code": "94577", "latitude": 37.72492039999999, "longitude": -122.1553988, "name": "PilotCity", "photos": [{ "height": 1470, "html_attributions": ["<a href=\"https://maps.google.com/maps/contrib/104152033260779671835/photos\">PilotCity</a>"], "width": 2048, "getUrl": { "_custom": { "type": "function", "display": "<span>ƒ</span> (g)" } } }, { "height": 1126, "html_attributions": ["<a href=\"https://maps.google.com/maps/contrib/104152033260779671835/photos\">PilotCity</a>"], "width": 2150, "getUrl": { "_custom": { "type": "function", "display": "<span>ƒ</span> (g)" } } }, { "height": 1283, "html_attributions": ["<a href=\"https://maps.google.com/maps/contrib/104152033260779671835/photos\">PilotCity</a>"], "width": 2452, "getUrl": { "_custom": { "type": "function", "display": "<span>ƒ</span> (g)" } } }, { "height": 3024, "html_attributions": ["<a href=\"https://maps.google.com/maps/contrib/114013528308167523915/photos\">Stephen Cassidy</a>"], "width": 4032, "getUrl": { "_custom": { "type": "function", "display": "<span>ƒ</span> (g)" } } }, { "height": 1535, "html_attributions": ["<a href=\"https://maps.google.com/maps/contrib/104152033260779671835/photos\">PilotCity</a>"], "width": 2049, "getUrl": { "_custom": { "type": "function", "display": "<span>ƒ</span> (g)" } } }, { "height": 2790, "html_attributions": ["<a href=\"https://maps.google.com/maps/contrib/114013528308167523915/photos\">Stephen Cassidy</a>"], "width": 3868, "getUrl": { "_custom": { "type": "function", "display": "<span>ƒ</span> (g)" } } }, { "height": 1920, "html_attributions": ["<a href=\"https://maps.google.com/maps/contrib/104128811893657618456/photos\">L G</a>"], "width": 1080, "getUrl": { "_custom": { "type": "function", "display": "<span>ƒ</span> (g)" } } }, { "height": 384, "html_attributions": ["<a href=\"https://maps.google.com/maps/contrib/104152033260779671835/photos\">PilotCity</a>"], "width": 384, "getUrl": { "_custom": { "type": "function", "display": "<span>ƒ</span> (g)" } } }], "place_id": "ChIJQ64IjpaPj4ARSzL0-FVHw-s" },
      department: 'test',
    ...
    this.internship = {
      ...
      travel: this.ΙΝΤΕRN_TRAVEL_OPTIONS[0],
