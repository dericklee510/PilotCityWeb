...
export interface Employer_Profile_V1 {
    ...
    organization_product_list?: Maybe<Maybe<Scalars['String']>[]>;
    ...
    projects_solutions?: Maybe<Maybe<Scalars['String']>[]>;
...
export interface MutationUpdatePublicCitizenProfileArgs {
...
export interface MutationCreatePublicCitizenProfileArgs {
    id_token: Scalars['String'];
...
export interface MutationUpdatePrivateCitizenProfileArgs {
    id_token: Scalars['String'];
...
export interface MutationCreateEmployerProfileArgs {
    id_token: Scalars['String'];
    ...
    organization_industry_other?: Maybe<Scalars['String']>;
    organization_product_list: Maybe<Scalars['String']>[];
    ...
    projects_solutions: Maybe<Scalars['String']>[];
...
export interface MutationCreateTeacherProfileArgs {
    id_token: Scalars['String'];
    ...
    tool_equipment?: Maybe<Maybe<Scalars['String']>[]>;
...
export interface Private_Citizen_Profile {
...
export interface Public_Citizen_Profile {
...
export interface QueryTeacherProfileArgs {
    user_id: Scalars['String'];
}


export interface QueryEmployerProfileArgs {
    user_id: Scalars['String'];
}


export interface QueryPublicCitizenProfileArgs {
    user_id: Scalars['String'];
}


export interface QueryPrivateCitizenProfileArgs {
    user_id: Scalars['String'];
}

export interface Teacher_Profile_V1 {
...
export interface PublicProfileFetchQueryVariables {
    user_id: Scalars['String'];
}
...
export interface PublicEmployerFetchQueryVariables {
    user_id: Scalars['String'];
}
...
export interface CreatePublicCitizenProfileMutationVariables {
    id_token: Scalars['String'];
    first_name: Scalars['String'];
    last_name: Scalars['String'];
    citizen_type: Scalars['String'];
...
export interface CreateEmployerProfileMutationVariables {
    id_token: Scalars['String'];
    citizen_first_name: Scalars['String'];
    citizen_last_name: Scalars['String'];
    citizen_position: Scalars['String'];
