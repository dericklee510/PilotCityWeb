...
declare module "filepond" {
    ...
    namespace server{
        ...
        type load = (source: string, load: (file: File) => void, error: (error_message: string) => void, progress: (endlessMode: boolean, loadedSize: number, totalSize: number) => void, abort: () => void, headers: (headersString: string) => void) => void | { abort: () => void } | Promise<void> | Promise<{ abort: () => void }>
    }
